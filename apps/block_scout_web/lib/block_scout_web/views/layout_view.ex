defmodule BlockScoutWeb.LayoutView do
  ...
  @issue_url "https://github.com/compverse/blockscout/issues/new"
  @default_other_networks [
    ...
    %{
      title: "Testnet",
      url: "https://pegasus.compverse.io/",
      test_net?: true
    }
  ]
  ...
  def logo do
    Keyword.get(application_config(), :logo) || "/images/compverse_logo.svg"
  end

  def logo_footer do
    Keyword.get(application_config(), :logo_footer) || Keyword.get(application_config(), :logo) ||
      "/images/compverse_logo.svg"
  end
  ...
  def network_title do
    Keyword.get(application_config(), :network) || "Network"
  end
    ...
    release_link =
      cond do
        ...
        release_link_env_var == "" || release_link_env_var == nil ->
          "https://github.com/compverse/blockscout/releases/tag/" <> version
